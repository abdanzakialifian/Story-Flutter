                ...
                children: [
                  Row(
                    ...
                    children: [
                      SafeOnTap(
                        onSafeTap: () =>
                            baseProvider.setLanguage = Constants.en,
                        child: Text(
                          "EN",
                          style: TextStyle(
                            fontWeight:
                                getFontWeight(baseProvider, Constants.en),
                      ...
                      SafeOnTap(
                        onSafeTap: () =>
                            baseProvider.setLanguage = Constants.id,
                        child: Text(
                          "ID",
                          style: TextStyle(
                            fontWeight:
                                getFontWeight(baseProvider, Constants.id),
